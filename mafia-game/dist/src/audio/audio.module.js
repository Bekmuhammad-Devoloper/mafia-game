...
exports.AudioModule = AudioModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [audio_service_1.AudioService, tts_service_1.TtsService, audio_scripts_service_1.AudioScriptsService],
        exports: [audio_service_1.AudioService, tts_service_1.TtsService, audio_scripts_service_1.AudioScriptsService],
    })
], AudioModule);
