...
exports.AudioScriptsService = void 0;
const common_1 = require("@nestjs/common");
const client_1 = require("@prisma/client");
let AudioScriptsService = class AudioScriptsService {
    gameStartScripts = [
        {
            category: client_1.AudioCategory.GAME_START,
            variant: 1,
...
tayyormisiz?`,
    ...
    nightStartScripts = [
        {
            category: client_1.AudioCategory.NIGHT_START,
            variant: 1,
...
bugun kechada hal bo'ladi...`,
    ...
    mafiaWakeScripts = [
        {
            category: client_1.AudioCategory.MAFIA_WAKE,
            variant: 1,
...
yo'qolib ketishi kerak?`,
    ...
    sheriffWakeScripts = [
        {
            category: client_1.AudioCategory.SHERIFF_WAKE,
            variant: 1,
...
oching...`,
    ...
    doctorWakeScripts = [
        {
            category: client_1.AudioCategory.DOCTOR_WAKE,
            variant: 1,
...
bering...`,
    ...
    donWakeScripts = [
        {
            category: client_1.AudioCategory.DON_WAKE,
            variant: 1,
...
ochishga vaqt keldi...`,
    ...
    morningNoDeathScripts = [
        {
            category: client_1.AudioCategory.MORNING_NO_DEATH,
            variant: 1,
...
tirikman. Lekin kurash davom etmoqda...`,
    ...
    morningDeathScripts = [
        {
            category: client_1.AudioCategory.MORNING_DEATH,
            variant: 1,
...
Lekin biz taslim bo'lmaymiz!`,
    ...
    discussionScripts = [
        {
            category: client_1.AudioCategory.DISCUSSION,
            variant: 1,
...
haqiqatni topish uchun yetarli vaqtmi? Ko'ramiz...`,
    ...
    votingScripts = [
        {
            category: client_1.AudioCategory.VOTING,
            variant: 1,
...
ketadi?`,
    ...
    eliminationScripts = [
        {
            category: client_1.AudioCategory.ELIMINATION,
            variant: 1,
...
imkoniyat...`,
    ...
    winCiviliansScripts = [
        {
            category: client_1.AudioCategory.WIN_CIVILIANS,
            variant: 1,
...
g'alabaga erishdingiz! Tabriklaymiz!`,
    ...
    winMafiaScripts = [
        {
            category: client_1.AudioCategory.WIN_MAFIA,
            variant: 1,
...
qutqaring!`,
    ...
    playerJoinedScripts = [
        {
            category: client_1.AudioCategory.PLAYER_JOINED,
            variant: 1,
    ...
    timerWarningScripts = [
        {
            category: client_1.AudioCategory.TIMER_WARNING,
            variant: 1,
    ...
    getScriptsByCategory(category) {
        switch (category) {
            case client_1.AudioCategory.GAME_START:
                return this.gameStartScripts;
            case client_1.AudioCategory.NIGHT_START:
                return this.nightStartScripts;
            case client_1.AudioCategory.MAFIA_WAKE:
                return this.mafiaWakeScripts;
            case client_1.AudioCategory.SHERIFF_WAKE:
                return this.sheriffWakeScripts;
            case client_1.AudioCategory.DOCTOR_WAKE:
                return this.doctorWakeScripts;
            case client_1.AudioCategory.DON_WAKE:
                return this.donWakeScripts;
            case client_1.AudioCategory.MORNING_NO_DEATH:
                return this.morningNoDeathScripts;
            case client_1.AudioCategory.MORNING_DEATH:
                return this.morningDeathScripts;
            case client_1.AudioCategory.DISCUSSION:
                return this.discussionScripts;
            case client_1.AudioCategory.VOTING:
                return this.votingScripts;
            case client_1.AudioCategory.ELIMINATION:
                return this.eliminationScripts;
            case client_1.AudioCategory.WIN_CIVILIANS:
                return this.winCiviliansScripts;
            case client_1.AudioCategory.WIN_MAFIA:
                return this.winMafiaScripts;
            case client_1.AudioCategory.ROLE_CIVILIAN:
            case client_1.AudioCategory.ROLE_MAFIA:
            case client_1.AudioCategory.ROLE_DON:
            case client_1.AudioCategory.ROLE_SHERIFF:
            case client_1.AudioCategory.ROLE_DOCTOR:
                return this.roleScripts.filter(s => s.category === category);
            case client_1.AudioCategory.PLAYER_JOINED:
                return this.playerJoinedScripts;
            case client_1.AudioCategory.TIMER_WARNING:
                return this.timerWarningScripts;
            default:
                return [];
        }
    }
    fillTemplate(text, params) {
        let result = text;
...
exports.AudioScriptsService = AudioScriptsService;
exports.AudioScriptsService = AudioScriptsService = __decorate([
    (0, common_1.Injectable)()
], AudioScriptsService);
//# sourceMappingURL=audio-scripts.service.js.map